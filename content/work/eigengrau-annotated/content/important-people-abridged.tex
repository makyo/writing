...
\begin{verse}[1.01\textwidth]
  I see your past in cross-processed film,\marginnote{A technique wherein slide film is processed as though it were print film, leading to overblown colors and a slight yellowish tint.}\\
  ...
  in umber and sienna and amber, in a younger sun.\marginnote{Colors invogue in the 60s and 70s.}\\
...
\begin{verse}[1.01\textwidth]
  Complementary, clashing anxieties.\marginnote{Perhaps I should not have included this one. Perhaps it's a memorial.}\\
...
\begin{verse}[1.01\textwidth]
  ...
  \vin Perhaps, perhaps, perhaps.\marginnote{Doris Day's song by the same title.}\\
  And now we're\\
  Awaiting weeks\\
  Of careful touches.
\end{verse}
...
\begin{verse}[1.01\textwidth]
\textit{Yit'gadal v'yit'kadash sh'mei raba}\marginnote{\emph{May his great name be exalted and sanctified}. From The Mourner's Kaddish, which is said at funerals and for eleven months after. }\\
...
\begin{verse}[1.01\textwidth]
  ...
  bedecked with sweet-pea\marginnote{Goodbye, departure, thank you.}\\
  and set about with violets.\marginnote{Modesty, or faithfulness.}\\
