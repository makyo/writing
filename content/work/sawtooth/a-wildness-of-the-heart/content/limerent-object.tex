...
I have slaved over these words so long that I think I nearly have the letter memorized. It's silly, in a way, to put this much energy into something, but this whole entire process has been silly. It's been silly since I caught myself having dreams about her, and before even that, when I started this whole journal process.
...
\ygTimestamp{Dee} Been thinking.

\ygTimestamp{Dee} We still talk a lot, and I really like that. For having only had a little bit of time together at UI, it's nice that we've been able to keep up with each other.

\ygTimestamp{Kay} Yeah?

\ygTimestamp{Kay} I mean, I like it too.

\ygTimestamp{Kay} I only talk to you and like two classmates from that time, and one only because he's also up here in Boise.

\ygTimestamp{Dee} Yeah.

\ygTimestamp{Dee} So I don't know if this is weird or not. It's not something I've ever done or

\ygTimestamp{Kay} ?

\ygTimestamp{Dee} Not something I've ever done or really felt, but I think I really like you.

\ygTimestamp{Dee} Know I really like you.

\ygTimestamp{Dee} And goodness knows I have no idea what to do about it.

\ygTimestamp{Dee} It's taken me weeks to even get to the point where I could say that.

\ygTimestamp{Kay} Huh\ldots{}

\ygTimestamp{Dee} ???

\ygTimestamp{Kay} I like you too, but I'm not sure if it's in the same way?

\ygTimestamp{Kay} Assuming you mean romantically.

\ygTimestamp{Dee} Yes.

\ygTimestamp{Kay} Yeah, see.

\ygTimestamp{Kay} I don't know.

\ygTimestamp{Dee} I don't either, I guess.

\ygTimestamp{Kay} I'm really not sure how to take this conversation haha

\ygTimestamp{Kay} I hope that's not

\ygTimestamp{Kay} I don't know

\ygTimestamp{Kay} Painful?

\ygTimestamp{Dee} Well.

\ygTimestamp{Kay} Yeah, sorry\ldots{}

\ygTimestamp{Dee} No no, I mean

\ygTimestamp{Dee} Well, it is, but that's not quite where I was going, hah.

\ygTimestamp{Kay} Sorry. I'll let you type.

\ygTimestamp{Dee} I don't really know what I wanted out of this conversation, to be honest. I wasn't even intending for it to be a conversation, at least right off the bat. I had a whole email written up that I was going to send you, to be perfectly nerdy about it.
...
\ygTimestamp{Dee} And I should add

\ygTimestamp{Dee} The goal is specifically not to do that. It wasn't to try and rope you into something you don't want to do, and I don't want to make it sound like I am trying to do so now.

\ygTimestamp{Dee} Guilt you into it or whatever.

\ygTimestamp{Dee} But I did want to talk about it and get it off my chest.

\ygTimestamp{Dee} And I guess that's it.

\ygTimestamp{Kay} Alright.

\ygTimestamp{Kay} I mean, I don't think you could guilt the wings off a fly, Dee.

\ygTimestamp{Kay} The whole Catholic thing is guilting yourself, right?

\ygTimestamp{Dee} That's a bit of an uncharitable way to put it.

\ygTimestamp{Kay} Sorry. You know I don't understand it.

\ygTimestamp{Dee} Yeah.

\ygTimestamp{Kay} And that's maybe part of it.

\ygTimestamp{Dee} How so?

\ygTimestamp{Kay} How would you feel being in a relationship with someone who doesn't believe the same stuff?

\ygTimestamp{Kay} Doesn't believe any of it, I mean.

\ygTimestamp{Kay} I'm not going to knock it or anything, but I'm not going to try it, either.

\ygTimestamp{Kay} I'm sorry.

\ygTimestamp{Dee} Hah.

\ygTimestamp{Dee} Sorry, that came out weird?
...
\ygTimestamp{Dee} And at the same time, I really do like you, and that is something I am happy to accommodate even in the context of our friendship.

\ygTimestamp{Dee} Because above all else, I'm simply happy to have you as my friend.

\ygTimestamp{Kay} Same!

\ygTimestamp{Dee} And even if a relationship isn't in our future, that's totally okay.

\ygTimestamp{Kay} Thanks Dee \textless3

\ygTimestamp{Kay} I don't know, it's weird.

\ygTimestamp{Kay} I kind of suspected, now that I think back on it? Not like you were being a weirdo.

\ygTimestamp{Kay} Or any more than usual ☺

\ygTimestamp{Kay} Just little things about how you acted when I was over. Nothing bad, just you had a certain distance about you, like you were being extra careful about something or guarding something. Like, every time you came over to my place and wound up sitting in my bed or something, you'd get all quiet.

\ygTimestamp{Kay} I realize after the fact that that was probably super weird for you. Sorry about that.

\ygTimestamp{Dee} Oh, are you saying I was more awkward than usual? Shock and surprise!

\ygTimestamp{Kay} Haha

\ygTimestamp{Dee} It was weird, but please don't put that on you. I just\ldots yeah, I was fighting with my emotions at the time, and huddling on your bed where literally all I could smell was you and with you being the sole focus of my attention, it was\ldots well.

\ygTimestamp{Dee} Intense, I guess.

\ygTimestamp{Kay} I bet.

\ygTimestamp{Kay} Still, I'm sorry, Dee.

\ygTimestamp{Kay} I won't say my `no' is absolute and forever, I can't predict that, but it is a `no' for now.

\ygTimestamp{Dee} Thanks, Kay.

\ygTimestamp{Dee} For being so open about it, I mean.

\ygTimestamp{Dee} And honest, I guess.

\ygTimestamp{Dee} Uh\ldots and to continue being awkward for at least a moment longer, are you okay remaining friends?

\ygTimestamp{Kay} Dee I swear to god

\ygTimestamp{Kay} If you did anything to stop being friends with me a) you would know it because I would kick your ass and b) I'd go fucking nuts. We're friends, okay? If a friendship can't take a challenge, what even is it, then? :P

\ygTimestamp{Dee} Haha. Well, good. I'm not keen on getting my ass kicked, and ditto. I'd rather have my nails pulled out that lose you as a friend.

\ygTimestamp{Kay} Gross

\ygTimestamp{Kay} ☺

\ygTimestamp{Dee} It feels surprisingly good to get that out.

\ygTimestamp{Kay} Even if it isn't the outcome you wanted?

\ygTimestamp{Dee} It's weird.

\ygTimestamp{Dee} I'm not sure what outcome it is that I really wanted.

\ygTimestamp{Dee} I mean, not gonna lie, if we'd wound up going out or whatever, that would've been nice! But I don't think that was \emph{actually} my goal. I think I really just wanted to get it off my chest. I wanted to not be holding it in and feeling like an idiot any longer.

\ygTimestamp{Kay} I bet!

\ygTimestamp{Kay} How long has it been, anyway?

\ygTimestamp{Kay} Shit. If you don't mind me asking, that is. I don't want to draw it out if this is just continuing to hurt you or anything ☹

\ygTimestamp{Dee} No, it's okay! It's made me a weird, giggly mess for some reason because apparently I'm still twelve, admitting that I have a crush, but it's good to talk about.

\ygTimestamp{Dee} Way better than an email would have been, yikes.

\ygTimestamp{Dee} But it's been about six months? A bit longer?

\ygTimestamp{Kay} Can I just say that you writing up a whole-ass email to tell me that you like me is the most Dee possible thing that I can think of?

\ygTimestamp{Dee} I set up an archetype for myself and have no choice but to live up to it.

\ygTimestamp{Kay} Nerd

\ygTimestamp{Kay} What was even in the email?

\ygTimestamp{Dee} I still have it in drafts. Want me to just send it?

\ygTimestamp{Kay} Sure

\ygTimestamp{Kay} Oh Dee

\ygTimestamp{Kay} This is incredibly sweet, jesus.

\ygTimestamp{Kay} You're still a total nerd

\ygTimestamp{Kay} But whoever you wind up with is gonna be the luckiest gal out there.

\ygTimestamp{Kay} Man, I'm sorry.

\ygTimestamp{Dee} ??

\ygTimestamp{Kay} I feel like I'm teasing you by saying that ☹

\ygTimestamp{Dee} I don't feel teased.

\ygTimestamp{Dee} A bit\ldots bashful, maybe?

\ygTimestamp{Dee} And I'm not going to lie that hearing that makes me a little bit hopeful for the future, but I stand by what I said that I'm alright with your answer, and am happy to have you as a friend.

\ygTimestamp{Kay} Uh

\ygTimestamp{Kay} Yeah, I don't know

\ygTimestamp{Kay} Let's talk about it in the future sometime, then? Because yeah, like

\ygTimestamp{Kay} Maybe we could make it work?

\ygTimestamp{Kay} But just not right now

\ygTimestamp{Kay} I can picture it in my mind, and you're cute and sweet and we have fun, but I guess I just can't say yes right now.

\ygTimestamp{Dee} For the future, then.

\ygTimestamp{Dee} For now, I'm gonna go order some food. Not to put an artificial stopper in this, but maybe we can just chill with a movie or something after?

\ygTimestamp{Kay} Yeah, sounds good ☺ Sci-fi bullshit?

\ygTimestamp{Dee} Oh, definitely sci-fi bullshit
