...
Only, sometimes it feels it must traipse across my lap as cats\footnotemark do, bunting its head against my arms, needle-sharp claws digging into my thighs, demanding that it receive the attention its due. ``Think of me,'' it says. ``Think of me and dream of me. Pet me and stroke me. Let me know that you love me, in your own fearful way.''}\footnotetext{Death, a constant, refuses to leave. I start writing this essay on death, and then the vet calls: your cat's asthma isn't asthma, it's metastatic lung cancer. Just keep her comfortable.\par You who read this, or perhaps future Madison, I don't write this that you feel sorry for me, but only for a little validation. Dwale dies. Falcon dies. Turtle is dying.}, but beyond that, we get only hints of assonance: `hands'/`land'.\footnote{My accent has hands as /\IPAfont{ɛ}/ vs land as /\IPAfont{æ}/.}
...
% - Apply the framework to poetry itself
%   (footnotes - apply to our relationship in retrospect with clearer eyes)
% - Conclusion: Spirals draw us inexorably onward/upward. We change, the year changes, and grief fades into sadness
