...
\begin{quote}
\textbf{Amendment to referendum \ldots{}}
...
\item
  The exchange of goods and services between the System and the governmental entity named in the trade agreement shall be binding by those two parties only.
\item
...
\item
  ...
  \end{enumerate}
\item
  The physical elements of the System including but not limited to the System hardware, resource infrastructure, and the ``Ansible system'' required for uploading shall be considered property of the System as a governmental entity.
\item
  The System of a governmental entity shall enact any and all regulations relating to its own governance, which no other governmental entity may hinder.
\end{enumerate}
...
\begin{description}
\tightlist
\item[Direct Democracy Representative individual]
Yared Zerezghi (NEAC) via Direct Democracy Representative.
\item[Governmental representative]
Yosef Demma (NEAC), Councilor.
\item[System-side representatives]
...
``My apologies, councilor. I went for a walk to clear my head. I'm\ldots{}'' He squinted around at the trees, then walked back to the street he'd come up. ``I'm at the woodland park, a ways north of my place. Does your driver know where that is?''
