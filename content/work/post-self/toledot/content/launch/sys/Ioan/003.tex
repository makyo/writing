...
``I'll bet. I'm thinking the triad on Pollux fell asleep instead. They're already diverging.'' Ey started a diagram on the page. ``So that's three. Would it be four total, then, with me to collate the information?''
...
Ioan tensed. Ey could feel eir cheeks burning. ``Uh\ldots another conversation I've never had to have before.''
