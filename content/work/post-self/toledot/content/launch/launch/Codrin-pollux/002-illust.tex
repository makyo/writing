...
\AddToHookNext{shipout/after}{\includepdf[pages={1},noautoscale=true,fitpaper=true]{assets/cairns}}
Dear splayed its ears. \emph{``It is hard to let go of that desire, yes. A few of them are quite mad now, however.''}
