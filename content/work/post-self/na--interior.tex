...
\def\Artist{Nathan \mbox{Allgood}}
\def\ArtType{2 interior illustrations}
\def\UpFront{\$250}
...
The Artist grants rights to use the Pieces to be published in conjunction with the Work in print and digital formats, and to be used in marketing and publication for the \WorkType.
...
The Author agrees to pay a flat fee of \FlatFee. The Author will furnish payment via \PaymentMechanism.
