...
\hypertarget{ketuvim}{%
\section*{3\hspace{1em}Ketuvim}\label{ketuvim}}
...
\noindent Dear wasn't kidding about the smells. Ioan turned eir sensorium way up in intensity. Ey wondered if Dear's vulpine nose could smell things eirs could not.
...
\noindent Dear shrugged and turned its back on Ioan.
...
\hypertarget{neviim}{%
\section*{5\hspace{1em}Nevi'im}\label{neviim}}
