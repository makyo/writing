...
> **Dear**: My sentiments exactly. It is another encryption scheme which relies on a deck of cards for a stream of random numbers. I haven't dug into it in years because the decryption process is so slow, but there may be a node on that box containing the encrypted text.
>
...
> **Dear**: It kind of worked, I'll put it that way. I feel pretty well rounded, as much as that means, and I'm sure those across the clade from me do too, but it's complicated. You would not recognize my cocladists as Odists without knowing beforehand. It's like having a very close sib that was raised by a different family in a different sim.
>
...
>
> **Dear**: \*calmer\* Don't worry about it. It's all good, I promise. It's just that we're really good at arguing, so I've been dealing with that a lot the last few days. That's why I hired you; I'm relegated to an administration role so I'm a bit on edge. Let's get back to the archive server, yeah?
>
...
>
> **Dear**: \*laughter\* I was going to say historian, sounding more like an historian every time we talk. But you never know, maybe you'd make a good PI.
