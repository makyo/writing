...
%  \input{qoheleth/content/gallery-exhibition-plain}
  ...
  \renewcommand*{\theHpart}{anticipation}
  \part{Anticipation}
  ...
  \renewcommand*{\theHpart}{experience}
  \part{Experience}
  ...
  \renewcommand*{\theHpart}{intensity}
  \part{Intensity}
  ...
  \renewcommand*{\theHpart}{integration}
  \part{Integration}
...
%  \addcontentsline{toc}{part}{Mitzvot}
  ...
  \renewcommand*{\theHpart}{conversation}
  \part{Conversation}
  \vfill

  \input{mitzvot/content/001}
  \input{mitzvot/content/002}
  \input{mitzvot/content/003}
  \input{mitzvot/content/004}
  \input{mitzvot/content/005}
  \input{mitzvot/content/006}
  \input{mitzvot/content/007}
  \input{mitzvot/content/008}

  \renewcommand*{\theHpart}{conflict}
  \part{Conflict}
  \vfill

  \input{mitzvot/content/009}
  \input{mitzvot/content/010}
  \input{mitzvot/content/011}
  \input{mitzvot/content/012}
  \input{mitzvot/content/013}
  \input{mitzvot/content/014}
  \input{mitzvot/content/015}
  \input{mitzvot/content/016}
  \input{mitzvot/content/016}
  \input{mitzvot/content/017}

  \renewcommand*{\theHpart}{apprehension}
  \part{Apprehension}
  \vfill
  
  \input{mitzvot/content/018}
  \input{mitzvot/content/019}
  \input{mitzvot/content/020}
  \input{mitzvot/content/021}
  \input{mitzvot/content/022}
  \input{mitzvot/content/023}
  \input{mitzvot/content/024}
  \input{mitzvot/content/025}
  \input{mitzvot/content/026}
  \input{mitzvot/content/027}
  \input{mitzvot/content/028}

  \renewcommand*{\theHpart}{reconcilliation}
  \part{Reconcilliation}
  \vfill

  \input{mitzvot/content/029}
  \input{mitzvot/content/030}
  \input{mitzvot/content/031}
  \input{mitzvot/content/032}
  \input{mitzvot/content/033}
  \input{mitzvot/content/034}
  \input{mitzvot/content/035}
  \input{mitzvot/content/036}

  \part*{Epilogue}
  \vfill
  \input{mitzvot/content/037}


%  \markboth{Selected Letters}{}
%  \part*{Selected Letters}
%  \addcontentsline{toc}{part}{Selected Letters}

%  \input{mitzvot/content/letters/sorina/001}
