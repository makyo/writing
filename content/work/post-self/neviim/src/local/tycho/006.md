...
"Might as fucking well be." She walked over to one one of the panels of news feed. This was labeled *Science* beneath, and seemed to head up a column of related material. "Might as well start here."
...
The final panel contained simply the string of messages that had been received so far followed by `Leaked anonymously ;)`
