...
``\emph{Rehasiër munachla achles eslosam. Tapotevier les unachadev The-Only-Time-I-Know-My-True-Name-Is-When-I-Dream-am, ite True-Name.}'' The skunk bowed formally, deep and at the waist.
...
``\emph{Lo,}'' Stolon said, speaking slowly. ``Planetary scale for us. For other three races.''
...
``We saw\ldots{}\emph{lo\ldots{}}'' They chattered their teeth for a moment, then looked to Iska. ``\emph{Baenå' puta' `esbrohakadåt'?}''
...
Stolon, meanwhile, was clacking claw-tipped fingers against the table and bobbing their head. ``\emph{Za putatier, za, za,}'' it said quickly. ``Will say, will say. Excited also, scientist Tycho.''
...
That unnerved, anxious expression returned to the secondracer's face, but they bowed their head all the same. ``\emph{Aet.} Thank you.''
