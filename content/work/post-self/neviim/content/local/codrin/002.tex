...
\emph{``That is more understandable, yes,''} the fox said. \emph{``Perhaps the True Name here on Castor has diverged from that Legrange in that respect, perhaps not. I suspect that both are disappointed, in their own ways.''}
