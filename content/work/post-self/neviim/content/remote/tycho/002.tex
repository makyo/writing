...
She nodded. ``To make sure that I am understanding correctly, you are not comfortable explaining how it is that each race went from a biological form to an uploaded form. \emph{Anem?}''

``\emph{Ato esles,}'' Turun Ko said. ``Would be better to describe-explain us as post-biological. Physical form to uploaded-embedded form.''
...
``You are proud of having achieved this, \emph{ka?}'' Turun Ka said. ``A separate embedded society from the physical society you have left behind on Earth?''
