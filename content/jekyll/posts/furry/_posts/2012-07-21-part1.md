---
counts:
    characters_real: 59204
    characters_total: 72343
    file: ./posts/furry/_posts/2012-07-21-part1.markdown
    paragraphs: 159
    type: jekyll
    words: 12763
layout: post
permalink: /furry/part1/
...
of fiction.  Disney's _Robin Hood_, the _Redwall_ books by
...
Garth Nix's _Old Kingdom_ series (embarrassing admission: when I
first got into the fandom, I tried to a comic of _Sabriel_, the
...
umbrella term, but even to things that the creator _strenuously_
objects to being called "furry".  Steven R. Boyett wrote a book in
1986 named _The Architect of Sleep_, a novel which features the
...
![Species Breakdown](/assets/furry/species-breakdown.png)

One definite theme within the fandom is that, to 
[quote](http://rikoshi.gd-kun.net/furry.html)
...
fandom. An 
[informal
poll](http://forums.furaffinity.net/threads/61671-Furs-By-Species-2)
shows them making up nearly a third of all respondents. There are even
...
_Default fur so far: a wolf._

![Age distribution](/assets/furry/age.png)
...
_Default fur so far: a 22 year old wolf._

![Sex and Gender](/assets/furry/sex-gender.png)
...
_Default fur so far: a 22 year old male wolf._

![Sexual orientation](/assets/furry/orientation.png)
...
uneven seeming distribution. Even so...

_Default fur so far: a 22 year old gay male wolf._

![Importance of sex](/assets/furry/sex-importance.png)
...
_Default fur so far: a 22 year old gay male wolf looking to get
laid._
...
_Default fur: a tipsy, awkward, 22 year old gay male wolf looking
to get laid. Cute, huh?_

![RandomWolf](/assets/furry/randomwolf-raw.png)
...
idea that I'm talking about is the concept of what furry _is_.
...
strategy", as named by Daniel Chandler in _The Act of Writing_.
...
strategy, "rewrite in process ... interferes with flow and rhythm, which
...
I've done with \[a\]\[s\] is rehashing ideas I've heard of or learned about
...
![Language hierarchy](/assets/furry/language-hierarchy.png)
...
\[adjective\]\[species\] would be a corpus - though it can be taken in
...
the reason that it's _important_ is because, in particular, our choices
...
Moderate Whorfianism. In his book _The Act of Writing_, Daniel
...
* it is a two-way process, so that 'the kind of language we use' is
  also influenced by 'the way we see the world'
* any influence is ascribed not to 'Language' as such or to one
  language as compared with another, but to the use _within a
  language_ of one variety rather than another (typically a
  _sociolect_ - the language used primarily by members of a
...
![Semiotic hierarchy](/assets/furry/semiotic-hierarchy.png)
...
_Straight_, Hanne Blank makes a similar argument that the growth
...
_Watership Down_ and "Robin Hood", or perhaps Coyote or Raven or
...
modalities. We produce _a lot_. It is to the point where it's
...
things _are_ important to us, too. The meanings we create
